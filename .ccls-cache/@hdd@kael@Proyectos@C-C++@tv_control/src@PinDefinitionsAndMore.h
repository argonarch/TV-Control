...
//#define _IR_MEASURE_TIMING // For debugging purposes.
    ...
    defined(__AVR_ATtiny85__)  // Digispark board. For use with ATTinyCore.
...
#define IR_SEND_PIN                                                            \
  PIN_PB4 // Pin 2 is serial output with ATtinySerialOut. Pin 1 is internal LED
          // and Pin3 is USB+ with pullup on Digispark board.
...
#define IR_RECEIVE_PIN                                                         \
  PIN_PA3 // On Digispark board labeled as pin 9 - INT0 is connected to USB+ on
          // DigisparkPro boards
...
#define _IR_TIMING_TEST_PIN PIN_PB0 // 8
    ...
    defined(__AVR_ATtiny3217__) // For use with megaTinyCore
// Tiny Core Dev board
...
#undef LED_BUILTIN // No LED available, take the one which is connected to the
                   // DAC output
...
#define IR_RECEIVE_PIN                                                         \
  PIN_PA6 // 2 - To be compatible with interrupt example, pin 2 is chosen here.
...
#define NO_LED_FEEDBACK_CODE // The  WS2812 on pin 8 of AI-C3 board crashes if
                             // used as receive feedback LED, other I/O pins are
                             // working...
...
#undef IR_SEND_PIN // SendPin is determined by timer! This avoids warnings in
                   // IRremote.hpp and IRTimer.hpp
#endif
#endif
